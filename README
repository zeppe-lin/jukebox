...
======================
jukebox is a music player for large collections of audio files.

This jukebox distribution is a fork of squentin's gmusicbrowser as of
version 1.1.16.  Added Papirus-Light/Trinity icons.  Removed
Elementary icons.  Artistinfo plugin was rewritten.
...
- last.fm info: retrieve artist-relevant information from last.fm
...
----------------------------
It's highly unrecommended since gmusicbrowser is fine and maintained
program with gtk3 support (unlike jukebox).  See gmusicbroser.org and
